...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        // Creating an object of User class and storing the current logged in user first
        User tester = userLoggedInService.getLoggedInUser();

        //Implementing this method to return the list of test requests assigned to current tester
